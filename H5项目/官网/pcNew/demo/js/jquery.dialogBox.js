 	...
 	DialogBox.prototype = {	
 		...
 		create: function(element){
 			...
 			if(!title){
 				...
 				if(!hasClose){
					dialogHTML[0] = '<section class="dialog-box"><div class="dialog-box-container"><div class="dialog-box-title"><p>'+ title + '</p></div><div class="dialog-box-content"></div>';
 				}else{					
 					dialogHTML[0] = '<section class="dialog-box"><div class="dialog-box-container"><div class="dialog-box-title"><p>'+ title + '</p><span class="dialog-box-close">×</span></div><div class="dialog-box-content"></div>';
 				}
 			}
 			...
 			if(!hasMask){
 				...
 				dialogHTML[2] = '<div class="dialog-box-mask"></div>';
 			}
 		...
 		hide: function(element){
 			...
 			// setTimeout(function(){
 				...
 				$dialogBox.replaceWith('<div class="' + $this.attr('class') + '"></div/>');
